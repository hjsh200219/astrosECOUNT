...
- **38개 도구 모듈** — ECOUNT ERP 핵심 CRUD + 물류/재무/운영 분석 + 외부 연동
...
| 축산물 이력 | `import-meat-trace` | MAFRA 축산물 이력추적 API 연동 |
...
축산물 이력추적 조회 기능을 사용하려면 [공공데이터포털](https://www.data.go.kr/) API키가 필요합니다.

| 변수 | 설명 |
|-----|------|
| `MAFRA_API_KEY` | 농림축산식품부 Open API 인증키 |
...
│   │   ├── ...                      # + 27개 분석/유틸/외부연동 도구
│   │   └── import-meat-trace.ts     # MAFRA 축산물 이력
│   ├── types/
