...
| 관계 | 추론 근거 |
|------|----------|
| CUSTOMER ↔ SALE | `ecount_save_sale` 스키마에 CUST 필드 존재 |
| PRODUCT ↔ SALE | `ecount_save_sale` 스키마에 PROD_CD 필드 존재 |
| CUSTOMER ↔ QUOTATION | `ecount_save_quotation` 스키마에 CUST 필드 존재 |
