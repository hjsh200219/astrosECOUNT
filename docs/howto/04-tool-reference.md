...
### ecount_inventory_list_inventory_by_location
...
### ecount_accounting_save_invoice_auto
- **설명**: 자동 세금계산서 저장
...
### ecount_other_save_open_market_order
- **설명**: 오픈마켓 주문 저장
...
### ecount_other_save_clock_in_out
- **설명**: 출퇴근 기록 저장
...
|------|--------|-----------|------|----------|----------|----------|
| `app.inventory` | `SelectInventorySearchListAction` | `sales` | 판매조회 | `B_000000E040205` | 622건 | 구현 (ecount_internal_list_sales_internal) |
| `app.inventory` | `SelectInventorySearchListAction` | `purchases` | 구매조회 | `B_000000E040303` | 261건 | 구현 (ecount_internal_list_purchases_internal) |
