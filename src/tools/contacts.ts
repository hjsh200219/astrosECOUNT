...
const CONTACTS: Contact[] = [
  // 아스트로스 (5명)
  { name: "이호진", company: "아스트로스", role: "대표", department: "경영", notes: "총괄" },
  { name: "김영미", company: "아스트로스", role: "경리", department: "회계", notes: "매입/매출 관리" },
  { name: "박준혁", company: "아스트로스", role: "물류담당", department: "물류", notes: "선적/통관 관리" },
  { name: "최서연", company: "아스트로스", role: "영업", department: "영업", notes: "판매처 관리" },
  { name: "정민우", company: "아스트로스", role: "구매", department: "구매", notes: "발주/수입 관리" },
  // 삼현INT (2명)
  { name: "김민수", company: "삼현INT", role: "과장", department: "수입대행", notes: "수입대행 메인 담당" },
  { name: "이지은", company: "삼현INT", role: "대리", department: "수입대행", notes: "서류 처리" },
  // 정운관세법인 (3명)
  { name: "박태호", company: "정운관세법인", role: "관세사", department: "통관", notes: "통관 총괄" },
  { name: "한수진", company: "정운관세법인", role: "관세사", department: "통관", notes: "일반 통관" },
  { name: "오재현", company: "정운관세법인", role: "팀장", department: "통관", notes: "서류 검토" },
  // 원스탑관세법인 (1명)
  { name: "강동훈", company: "원스탑관세법인", role: "관세사", department: "통관", notes: "전지벌크 전담" },
  // 디케이통상 (1명)
  { name: "송재호", company: "디케이통상", role: "부장", department: "영업", notes: "브라질 공급사 연락 창구" },
  // 기타
  { name: "Maria Silva", company: "BRF S.A.", role: "Export Manager", department: "Export", notes: "브라질 수출 담당 (포르투갈어)" },
];
